...
import Myfavorites from '../../../components/User/Client/myhome/Myfavorites';

export class MyFavoritesPage extends Component {
    ...
    removeFavor=(id)=>{
        callApi(`/api/user/favorites/${id}/delete`, 'DELETE', null, {
            ...
            if(res.status >= 200 && res.status <400){
                swal("Great!", "RemoveFavor Successfully!", "success")
                callApi('/api/user/favorites/list?page=1&page_size=10', 'GET', null, {
                    Authorization: `JWT ${localStorage.getItem('token')}`
                }).then(res => {
                    //console.log(res.data.results);
                ...
                swal("Error!", "RemoveFavor Error!", "error")
            }
        }).catch(err => {
                    ...
                    <div className="row">
                        <div className="row-left">
                            <div className="row-left-content">
                                <Myfavorites products={faproducts} removeFavor={this.removeFavor}/>
                            </div>
                        </div>
